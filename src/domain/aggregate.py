...
from src.patterns import Aggregate
...
class BankAccount(Aggregate):
    ...
    def open(cls, full_name: str, email_address: str) -> 'BankAccount':
        ...
        return super()._create_(cls.Opened, full_name=full_name, email_address=email_address)
    ...
    def append_transaction(self, amount: Decimal) -> None:
        ...
        self._trigger_(self.TransactionAppended, amount=amount)
    ...
    class TransactionAppended(Aggregate.Event):
        """Domain event for when transaction is appended to bank account."""
    ...
    def set_overdraft_limit(self, overdraft_limit: Decimal) -> None:
        ...
        self.check_account_is_not_closed()
        self._trigger_(self.OverdraftLimitSet, overdraft_limit=overdraft_limit)

    class OverdraftLimitSet(Aggregate.Event):
        """Domain event for when overdraft limit is set."""
